...
<<<<<<< HEAD
        ...
        const canReuseSerialized = !bulkOperation.s.usingAutoEncryption &&
        ...
        const operation = isInsertBatch(batch)
            ? new insert_1.InsertOperation(bulkOperation.s.namespace, batch.operations, finalOptions, serialized)
            : isUpdateBatch(batch)
                ? new update_1.UpdateOperation(bulkOperation.s.namespace, batch.operations, finalOptions, serialized)
                : isDeleteBatch(batch)
                    ? new delete_1.DeleteOperation(bulkOperation.s.namespace, batch.operations, finalOptions, serialized)
=======
        const operation = isInsertBatch(batch)
